...
export default class RideScreen extends Component {
    ...
    handleTransaction = async () => {
        ...
        // Verifique a disponibilidade da bicicleta usando a função 'checkBikeAvailability()' e passe o argumento 'bikeId' (id da bicicleta). Armazene o status em uma variável 'transactionType'
        var transactionType = await this.checkBikeAvailability(bikeId);
        // Verifique se a variável 'transactionType' está vazia
        if (!transactionType) {
            // se 'transactionType' estiver vazia, torne o valor 'bikeId' como ""
            this.setState({ bikeId: "" });
            // Faça uma mensagem de alerta aparecer na tela para inserir um ID de bicicleta válido
